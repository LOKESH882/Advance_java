...
public class ProductController {
	...
	//localhost:8080/employeeapi/employee2
		...
		public void updateEmpData3(@RequestBody Employee emp, @RequestParam int id) {
		...
		//localhost:8080/employeeapi/employee2
		@PutMapping(value = "employee2")
		public String updateEmpData4(@RequestBody Employee emp, @RequestParam int id) {
		System.out.println("ID -> "+id);
		System.out.println(emp);
		return "*****Data Updated*****";
				}
		...
		//localhost:8080/employeeapi/employee/555
		...
		//localhost:8080/employeeapi/employee2/555
		@DeleteMapping(value = "employee2/{id}")
		public String DeleteEmpData2(@PathVariable int id) {
			System.out.println("ID-> "+id);
			System.out.println("Data Deleted...");
			return "Data Deleted...";
		}
