...
public class MainClass {
	public static void main(String[] args) {
		...
		/*
		 * Idea idea = context.getBean(Idea.class); System.out.println(idea);
		 * 
		 * Jio jio = context.getBean(Jio.class); System.out.println(jio);
		 */
		
		phone.getSimOperation_jio().calling();
		phone.getSimOperation_idea().calling();
	}
}
